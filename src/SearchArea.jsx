...
const SearchArea = ({ loading, search, setSearch, handleChange }) => {
  ...
  return (
    <div className="relative text-lg mx-auto mb-10 mb-5 max-w-[800px]">
      <input type="text" value={search} onChange={handleChange} placeholder="جستجو کنید..." className="w-full px-16 py-3 border border-3xl border-slate-300 focus:outline-2 outline-slate-300 outline-offset-4 rounded-full" />
      ...
      { search? (<div className='bg-white/80' onClick={() => {setSearch('')}}>
